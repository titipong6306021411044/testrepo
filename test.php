...
<body>
    ...
    year:<br><select id="sel_year" onchange="load_title()"><option value="">N\A</option></select><br>
    movie title:<br><select id="Movie_Title" onchange="load_movie_content()"><option value="">N\A</option></select><br>
